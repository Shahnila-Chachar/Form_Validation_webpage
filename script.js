...
function validatePassword() {
    ...
    // Optional: Check for at least one letter, one number, and one special character
    ...
    passwordError.innerHTML = '<i class="fa-solid fa-check-circle" style="color:#4CAF50;"></i>';
    return true;
}
